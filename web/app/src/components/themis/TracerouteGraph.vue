...
.tr-head h3 { font-size: 1.58rem; font-weight: 600; color: var(--text); margin: 0; font-family: var(--font-display); }
.tr-meta { font-size: 1.19rem; color: var(--text-muted); }
...
.tr-state { display: flex; align-items: center; gap: 0.5rem; justify-content: center; padding: 1.1rem 0.75rem; background: var(--surface-2); border: 1px solid var(--border); border-radius: 8px; font-size: 1.4rem; color: var(--text-muted); }
...
.tr-ttl { width: 18px; text-align: right; font-family: var(--font-mono); font-size: 1.19rem; color: var(--text-muted); flex-shrink: 0; }
...
.tr-host { font-size: 1.4rem; color: var(--text); font-weight: 500; word-break: break-all; }
.tr-host.muted { color: var(--text-muted); font-weight: 400; font-style: italic; }
.tr-sub { font-size: 1.19rem; color: var(--text-muted); word-break: break-all; }
.mono { font-family: var(--font-mono); }

.tr-rtt { font-family: var(--font-mono); font-size: 1.22rem; color: var(--info); background: var(--surface-2); padding: 2px 7px; border-radius: 8px; flex-shrink: 0; }
.tr-target-tag { font-size: 1.05rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.04em; color: var(--accent-bright, var(--accent)); background: var(--accent-dim); padding: 2px 7px; border-radius: 8px; flex-shrink: 0; }
