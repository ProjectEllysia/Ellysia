...
.modal-body input { width: 100%; padding: 0.55rem 0.75rem; background: var(--surface-2); border: 1px solid var(--border); border-radius: 6px; color: var(--text); font-size: 1.49rem; }
.modal-body input:focus { outline: none; border-color: var(--accent); }
.hint { margin: 0.4rem 0 0; font-size: 1.22rem; color: var(--text-muted); }
