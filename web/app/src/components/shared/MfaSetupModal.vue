...
.modal-title { font-family: var(--font-display); font-size: 1.1rem; color: var(--text); }
.modal-close {
...
.secret-toggle {
  ...
  color: #c4a0e0; font-size: 0.78rem; text-decoration: underline; padding: 0;
}
...
.modal-form input {
  ...
  font-size: 0.9rem; font-family: var(--font-mono); letter-spacing: 0.1em;
